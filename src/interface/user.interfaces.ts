import { userSchema, returnedUserScherma, returnMultpleuserScherma, userUpdateScherma, returnCreateUser } from "../schemas/user.schema";
import { z } from 'zod'
...
export {
    IUser, IUserReturn, IUserUpdate, IUsersReturn, IUserCreateReturn
}